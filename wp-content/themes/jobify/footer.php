...
?>
		...
		<div class="footer-cta">
			<div class="container-fluid">
				<?php echo wpautop( get_theme_mod( 'cta-text', '<h2>Got a question?</h2>Feel free to send us an email or call us at +254 701 927 296' ) ); ?>
			</div>
		</div>
		<?php endif; ?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="copyright">
				<div class="container">
					<div class="site-info" style="color: 10px!important">
